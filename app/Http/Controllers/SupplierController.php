...
class SupplierController extends Controller
{
    public function getSupplier()
    {
        ...
        $suppliers = DB::select("SELECT s.*, CONCAT(s.supplier_code, ' - ', s.name) AS display_name, ci.name AS city_name FROM suppliers AS s LEFT JOIN cities AS ci ON ci.id=s.city_id WHERE s.supplier_type != 'G' ORDER BY name");
