            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-header position-relative"
                        ...
                        <button style="position:absolute;bottom:0;right:0;border-radius: 0;"
                            class="btn btn-warning btn-sm shadow-none text-white px-4" @click="print"
                            v-if="ledgers.length > 0">Print</button>
                    </div>
