<template>
                      ...
                      <div class="row">
                         <div class="col-lg-4">
                            <div class="form-group m-0">
                               <v-select :options="suppliers" id="suppliers" v-model="selectedSupplier"
 ...
 export default {
    ...
    methods: {
       ...
       getLedger() {
          if (this.selectedSupplier == null) {
             alert("Select first Supplier");
             document.querySelector("#suppliers [type='search']").focus();
             return;
          }
 
          let data = {
             id: this.selectedSupplier != null ? this.selectedSupplier.id : "",
             dateFrom: this.dateFrom,
             dateTo: this.dateTo,
          };
 
          axios.post("/api/getsupplier-ledger", data).then((res) => {
                     ...
                     <html>
                         ...
                         <body>
                             <div class='container'>
                                 ...
                                 <div class="row">
                                     <h2 style="margin:0;text-align:center">Supplier Ledger of ${this.selectedSupplier.name}</h2>
    ...
    mounted() {
       document.title = "Supplier Ledger Page";
    },
 };
 </script>
