...
<nav class="sb-topnav navbar navbar-expand" style="background:repeating-linear-gradient(45deg, black, #9e7effeb 100px)">
        ...
        <router-link class="d-none d-md-block text-decoration-none btn btn-sm text-white shadow-none border-0" style="margin-left: 10px !important;background:linear-gradient(45deg, #0053a9, #b31414);" to="/sales">POS SALE</router-link>
        @endif
        @if(in_array("purchase.store", $useraccess))
        <router-link class="d-none d-md-block text-decoration-none btn btn-sm text-white shadow-none border-0" style="margin-left: 5px !important;background:linear-gradient(45deg, #0053a9, #b31414);" to="/purchases">PURCHASE</router-link>
        @endif
        @if(in_array("quotation.store", $useraccess))
        <router-link class="d-none d-md-block text-decoration-none btn btn-sm text-white shadow-none border-0" style="margin-left: 5px !important;background:linear-gradient(45deg, #0053a9, #b31414);" to="/quotations">QUOTATION</router-link>
        @endif
        <!-- Navbar Search-->
